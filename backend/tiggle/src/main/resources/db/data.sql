...
VALUES (1, 1, 1, 'OUTCOME', 10000, '20230101', '첫 번째 지출 제목', '첫 번째 지출 내역'),
       (1, 1, 1, 'INCOME', 15000, '20230201', '월급', '첫 번째 수익 내역'),
       (2, 2, 2, 'OUTCOME', 20000, '20230303', '커피', '커피 지출 내역'),
       (3, 3, 3, 'OUTCOME', 10000, '20230401', '식비', '식비 지출 내역'),
       (4, 4, 4, 'OUTCOME', 22000, '20230505', '비상금', '비상금 지출 내역');
